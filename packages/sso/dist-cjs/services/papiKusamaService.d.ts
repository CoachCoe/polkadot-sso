...
export declare class PapiKusamaService {
    private papiService;
    private isConnected;
    ...
    submitSignedTransaction(signedExtrinsic: any, userAddress: string): Promise<{
        success: boolean;
        blockHash: string;
        txHash: string;
    }>;
...
//# sourceMappingURL=papiKusamaService.d.ts.map