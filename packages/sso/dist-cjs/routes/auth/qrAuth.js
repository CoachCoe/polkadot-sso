...
exports.checkQrAuthStatus = checkQrAuthStatus;
exports.handleQrCallback = handleQrCallback;
exports.getQrAuthResult = getQrAuthResult;
...
const qrAuthRequestSchema = zod_1.z.object({
    address: zod_1.z.string().min(1, 'Address is required'),
    client_id: zod_1.z.string().min(1, 'Client ID is required'),
});
const qrCallbackSchema = zod_1.z.object({
    challenge_id: zod_1.z.string().min(1, 'Challenge ID is required'),
 ...
 */
async function generateQrAuth(req, res) {
    try {
 ...
 */
async function checkQrAuthStatus(req, res) {
    try {
 ...
 */
async function handleQrCallback(req, res) {
    try {
 ...
 */
async function getQrAuthResult(req, res) {
    try {
        const { challenge_id } = req.query;
        if (!challenge_id || typeof challenge_id !== 'string') {
            res.status(400).json({
...
//# sourceMappingURL=qrAuth.js.map