...
exports.SIWEAuthService = void 0;
const chains_1 = require("../chains");
const crypto_1 = require("../utils/crypto");
class SIWEAuthService {
    constructor(defaultChainId = 'polkadot') {
        this.defaultChain = (0, chains_1.getChainById)(defaultChainId) || (0, chains_1.getChainById)('polkadot');
    }
    ...
    createChallenge(clientId, userAddress, chainId) {
        ...
        const chain = chainId ? (0, chains_1.getChainById)(chainId) : this.defaultChain;
...
exports.SIWEAuthService = SIWEAuthService;
