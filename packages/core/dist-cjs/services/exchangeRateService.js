...
exports.DEFAULT_EXCHANGE_RATE_CONFIG = exports.ExchangeRateService = void 0;
exports.createExchangeRateService = createExchangeRateService;
/**
...
class ExchangeRateService {
     ...
     */
    async getRates(fromCurrency, toCurrencies) {
        const rates = {};
     ...
     */
    async getCoinGeckoRate(fromCurrency, toCurrency) {
 ...
 */
function createExchangeRateService(config) {
