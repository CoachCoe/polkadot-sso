...
export function polkadotAuth(config: ExpressAuthConfig = {}) {
  const router = Router();

  const finalConfig: ExpressAuthConfig = {
    basePath: '/auth',
    routes: {
      signIn: '/signin',
      signOut: '/signout',
  ...
  router.get(finalConfig.routes!.challenge!, async (req: Request, res: Response) => {
    try {
  ...
  router.post(finalConfig.routes!.verify!, async (req: Request, res: Response) => {
    try {
  ...
  router.get(finalConfig.routes!.signIn!, (req: Request, res: Response) => {
    const providers = [
      {
        id: 'polkadot-js',
  ...
  router.post(finalConfig.routes!.signOut!, async (req: AuthenticatedRequest, res: Response) => {
    try {
  ...
  router.get(finalConfig.routes!.callback!, (req: Request, res: Response) => {
